...
export const WEB_SEARCH_SCHEMA: ConfigSchema = [
  ...
  { key: "useDuckDuckGoFallback", label: "Fall back to DuckDuckGo", type: "boolean", default: true, help: "When no SearXNG instance is reachable, do a keyless DuckDuckGo web search. Disable for air-gap / privacy configs." },
