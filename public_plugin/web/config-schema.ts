...
export const WEB_SCHEMA: ConfigSchema = [
  { key: "port", label: "Port", type: "number", default: 7717, min: 1, max: 65535, step: 1, help: "The browser chat server binds here." },
  ...
  { key: "guidance", label: "Channel guidance", type: "text", placeholder: "(uses built-in guidance)", help: "Overrides the web.guidance system-block text shown to the LLM." },
  { key: "guidancePriority", label: "Guidance block priority", type: "number", default: 8000, min: 0, step: 100, help: "Priority of the web.guidance system block." },
  { key: "conversationMaxTurns", label: "Conversation window — turns", type: "number", default: 60, min: 1, step: 1, help: "How many recent conversation turns are fed back to the LLM each beat." },
