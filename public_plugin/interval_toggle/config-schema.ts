...
export const INTERVAL_TOGGLE_SCHEMA: ConfigSchema = [
  { key: "baseIntervalMs", label: "Base frame rate (revert target)", type: "number", default: 900000, min: 1, step: 1000, unit: "ms",
    help: "The frame rate to revert to after a temporary hold (interval.hold). Set it to this agent's normal interval (60000 = 1 minute)." },
